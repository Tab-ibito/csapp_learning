...
00000000004019a0 <addval_273>:                                        #mov %rax, %rdi
...
00000000004019c3 <setval_426>:                                       #mov %rax, %rdi
...
00000000004019db <getval_481>:                                       #mov %eax, %edx
...
00000000004019ef <addval_490>:                                       #andb %bl, %bl
...
0000000000401a03 <addval_190>:                                       #mov %rsp, %rax
...
0000000000401a11 <addval_436>:                                       #mov %ecx, %esi
...
0000000000401a25 <addval_187>:                                        #mov %ecx, %esi #cmpb %al, %al
  401a25:	8d 87 89 ce 38 c0    	lea    -0x3fc73177(%rdi),%eax
  401a2b:	c3                   	ret

0000000000401a2c <setval_248>:                                        #orb %bl, %bl
  401a2c:	c7 07 81 ce 08 db    	movl   $0xdb08ce81,(%rdi)
  401a32:	c3                   	ret

0000000000401a33 <getval_159>:                                        #mov %edx, %ecx #cmpb %cl, %cl
...
0000000000401a40 <addval_487>:                                        #mov %eax, %edx #testb %al, %al
...
0000000000401a4e <getval_272>:                                        #orb %dl, %dl
...
0000000000401a68 <getval_311>:                                        #mov %edx, %ecx #orb %bl, %bl
...
0000000000401a75 <setval_328>:                                        #cmpb %d2, %d2
  401a75:	c7 07 81 c2 38 d2    	movl   $0xd238c281,(%rdi)
  401a7b:	c3                   	ret

0000000000401a7c <setval_450>:                                        #orb %cl, %cl
  401a7c:	c7 07 09 ce 08 c9    	movl   $0xc908ce09,(%rdi)
  401a82:	c3                   	ret

0000000000401a83 <addval_358>:                                        #mov %esp, %eax
...
0000000000401a91 <getval_169>:                                        #andb %al, %al
...
0000000000401aa5 <getval_472>:                                        #andb %dl, %dl
  401aa5:	b8 8d ce 20 d2       	mov    $0xd220ce8d,%eax
  401aaa:	c3                   	ret

0000000000401aab <setval_350>:                                        #mov %rsp, %rax
