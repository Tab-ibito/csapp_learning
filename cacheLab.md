...
@media print {
  ...
  body, .markdown-preview {
    background-color: #0d1117 !important; /* GitHub Dark 的背景色 */
    color: #c9d1d9 !important; /* GitHub Dark 的文字颜色 */
    -webkit-print-color-adjust: exact !important; /* 强制浏览器打印背景色 */
...
从for循环遍历的角度来讲，这样写可以让**B的第0行用完了就再也不用了，占着Cache坑位的变成了第4行**，冲突自然变少。
